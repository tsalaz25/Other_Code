/**
 * This class holds the dictionary for the Wordle project.
 * (Five letter word list taken from project at
 *   http://nifty.stanford.edu/2022/eroberts-spelling-bee-wordle/)
 *
 * (Two letter words were grabbed from dictionary.com and put in an array.)
 */

public class WordleDictionary {

    /**
     * String array containing the legal words for in Wordle.
     */
    ...
    public static String[] TWO_LETTER_WORDS = {
        "aa", "ad", "ae", "ag", "ah", "ai", "al", "am", "an", "as",
        "at", "au", "aw", "ax", "ay", "ba", "be", "bi", "by", "cy",
        "da", "de", "di", "do", "du", "ed", "eh", "el", "em", "en",
        "er", "et", "ew", "ex", "fa", "fi", "gi", "go", "ha", "he",
        "hi", "id", "if", "in", "io", "is", "it", "ja", "jo", "ka",
        "la", "li", "lo", "ma", "me", "mi", "mo", "mu", "my", "na",
        "no", "nu", "ob", "oc", "od", "oe", "of", "oh", "oi", "ok",
        "on", "op", "or", "os", "ou", "ow", "ox", "oy", "pa", "pe",
        "pi", "po", "qi", "qy", "ra", "re", "si", "so", "ta", "te",
        "ti", "to", "uh", "um", "un", "up", "us", "ut", "we", "wo",
        "xi", "xu", "ya", "ye", "yi", "yo", "ys", "za", "ze"
    };
}
