...
/* package ProjectNotes-0.1.0.0 */
#ifndef VERSION_ProjectNotes
#define VERSION_ProjectNotes "0.1.0.0"
#endif /* VERSION_ProjectNotes */
#ifndef MIN_VERSION_ProjectNotes
#define MIN_VERSION_ProjectNotes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ProjectNotes */
...
#define CURRENT_COMPONENT_ID "ProjectNotes-0.1.0.0-inplace-ProjectNotes"
